...
object HybridAquaticItems {
    ...
    val MANGLERFISH_FIN: RegistryObject<Item> = register(
        "manglerfish_fin"
    ) {
        ManglerfishArmorItem(
            HybridAquaticArmorMaterials.MANGLERFISH,
    ...
    val DEAD_BUTTON_CORAL_BLOCK =
        registerBlockItem("dead_button_coral_block", HybridAquaticBlocks.DEAD_BUTTON_CORAL_BLOCK)
    ...
    val DEAD_LOPHELIA_CORAL_BLOCK =
        registerBlockItem("dead_lophelia_coral_block", HybridAquaticBlocks.DEAD_LOPHELIA_CORAL_BLOCK)
    ...
    val GREAT_WHITE_SHARK_PLUSHIE =
        registerBlockItem("great_white_shark_plushie", HybridAquaticBlocks.GREAT_WHITE_SHARK_PLUSHIE)
    val HAMMERHEAD_SHARK_PLUSHIE =
        registerBlockItem("hammerhead_shark_plushie", HybridAquaticBlocks.HAMMERHEAD_SHARK_PLUSHIE)
    ...
    val STRIPPED_DRIFTWOOD_WOOD =
        registerBlockItem("stripped_driftwood_wood", HybridAquaticBlocks.STRIPPED_DRIFTWOOD_WOOD)
    ...
    val DRIFTWOOD_PRESSURE_PLATE =
        registerBlockItem("driftwood_pressure_plate", HybridAquaticBlocks.DRIFTWOOD_PRESSURE_PLATE)
    ...
    val AFRICAN_BUTTERFLY_SPAWN_EGG =
        registerSpawnEgg("african_butterfly_spawn_egg", HybridAquaticEntityTypes.AFRICAN_BUTTERFLY, 0xb57955, 0x1e3555)
    ...
    val TOADFISH_SPAWN_EGG =
        registerSpawnEgg("toadfish_spawn_egg", HybridAquaticEntityTypes.TOADFISH, 0xfcf2ce, 0x885e6d)
    ...
    val GLOWING_SUCKER_OCTOPUS_SPAWN_EGG = registerSpawnEgg(
        "glowing_sucker_octopus_spawn_egg",
    ...
    val CAULIFLOWER_JELLYFISH_SPAWN_EGG = registerSpawnEgg(
        "cauliflower_jellyfish_spawn_egg",
        HybridAquaticEntityTypes.CAULIFLOWER_JELLYFISH,
        0x623062,
        0x89a1d8
    )
    val COMPASS_JELLYFISH_SPAWN_EGG =
        registerSpawnEgg("compass_jellyfish_spawn_egg", HybridAquaticEntityTypes.COMPASS_JELLYFISH, 0xfcf9bd, 0xa16470)
    val FRIED_EGG_JELLYFISH_SPAWN_EGG = registerSpawnEgg(
        "fried_egg_jellyfish_spawn_egg",
        HybridAquaticEntityTypes.FRIED_EGG_JELLYFISH,
        0xfbbf2d,
        0x76445f
    )
    val LIONS_MANE_JELLYFISH_SPAWN_EGG = registerSpawnEgg(
    ...
    val FIREWORK_JELLYFISH_SPAWN_EGG = registerSpawnEgg(
        "firework_jellyfish_spawn_egg",
    ...
    val NUDIBRANCH_SPAWN_EGG =
        registerSpawnEgg("nudibranch_spawn_egg", HybridAquaticEntityTypes.NUDIBRANCH, 0xf7be47, 0xb853a3)
    ...
    val TIGER_SHARK_SPAWN_EGG =
        registerSpawnEgg("tiger_shark_spawn_egg", HybridAquaticEntityTypes.TIGER_SHARK, 0xb79167, 0xf0f3e6)
    ...
    private fun <T : Mob> registerSpawnEgg(
        ...
        return register(id) { SpawnEggItem(type.get(), primaryColor, secondaryColor, FabricItemSettings()) }
    }

    private fun registerBlockItem(id: String, block: Supplier<Block>): RegistryObject<Item> {
        return register(id) { BlockItem(block.get(), FabricItemSettings()) }
    }

    private fun registerPlaceableInWaterBlockItem(id: String, block: Supplier<Block>): RegistryObject<Item> {
        return register(id) { PlaceableInWaterItem(block.get(), FabricItemSettings()) }
    }
    ...
    private fun registerVerticallyAttachable(
        ...
        return register(id) { StandingAndWallBlockItem(standingBlock, wallBlock, FabricItemSettings(), direction) }
    }
}
