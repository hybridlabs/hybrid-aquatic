...
object FeatureBiomeModifications {
    ...
    // Forge removes the same features with the biome modifiers in data/hybrid_aquatic/forge/biome_modifier.
    ...
    private fun placedFeatures(vararg paths: String): List<ResourceKey<PlacedFeature>> =
        paths.map { ResourceKey.create(Registries.PLACED_FEATURE, ResourceLocation(it)) }
}
