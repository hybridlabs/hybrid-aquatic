...
class LanguageProvider(output: FabricDataOutput) : FabricLanguageProvider(output) {
    override fun generateTranslations(builder: TranslationBuilder) {
        ...
        mapOf(
            ...
            HybridAquaticBlocks.DRIFTWOOD_LOG.get() to "Driftwood Log",
            HybridAquaticBlocks.DRIFTWOOD_WOOD.get() to "Driftwood Wood",
            HybridAquaticBlocks.STRIPPED_DRIFTWOOD_LOG.get() to "Stripped Driftwood Log",
            HybridAquaticBlocks.STRIPPED_DRIFTWOOD_WOOD.get() to "Stripped Driftwood Wood",
            HybridAquaticBlocks.DRIFTWOOD_PLANKS.get() to "Driftwood Planks",
            HybridAquaticBlocks.DRIFTWOOD_STAIRS.get() to "Driftwood Stairs",
            HybridAquaticBlocks.DRIFTWOOD_SLAB.get() to "Driftwood Slab",
            HybridAquaticBlocks.DRIFTWOOD_FENCE.get() to "Driftwood Fence",
            HybridAquaticBlocks.DRIFTWOOD_FENCE_GATE.get() to "Driftwood Fence Gate",
            HybridAquaticBlocks.DRIFTWOOD_DOOR.get() to "Driftwood Door",
            HybridAquaticBlocks.DRIFTWOOD_TRAPDOOR.get() to "Driftwood Trapdoor",
            HybridAquaticBlocks.DRIFTWOOD_PRESSURE_PLATE.get() to "Driftwood Pressure Plate",
            HybridAquaticBlocks.DRIFTWOOD_BUTTON.get() to "Driftwood Button",
        ...
        mapOf(
            ...
            HybridAquaticItems.SERGEANT_MAJOR.get() to "Damselfish",
            ...
            HybridAquaticItems.YELLOWFIN_TUNA.get() to "Yellowfin Tuna",
            HybridAquaticItems.BLUEFIN_TUNA.get() to "Bluefin Tuna",
            ...
            HybridAquaticItems.TOADFISH.get() to "Toadfish",
            ...
            HybridAquaticItems.KOI.get() to "Koi",
            ...
            HybridAquaticItems.BLUE_TANG.get() to "Blue Tang",
            HybridAquaticItems.SURGEONFISH_SOHAL.get() to "Sohal Surgeonfish",
            HybridAquaticItems.YELLOW_TANG.get() to "Yellow Tang",
            HybridAquaticItems.POWDER_BLUE_TANG.get() to "Powder Blue Tang",
            HybridAquaticItems.SURGEONFISH_ORANGESHOULDER.get() to "Orangeshoulder Surgeonfish",
            HybridAquaticItems.SURGEONFISH_LINED.get() to "Lined Surgeonfish",
            HybridAquaticItems.CLOWNFISH.get() to "Clownfish",
            HybridAquaticItems.UNICORNFISH.get() to "Unicornfish",
            ...
            HybridAquaticItems.GLOW_SLIME.get() to "Glow Slime",
        ...
        // enchantments
        mapOf(
            HybridAquaticEnchantments.LIVECATCH.get() to "Live Catch",
    ...
    private fun generateEntities(builder: TranslationBuilder) {
        ...
        val entityNameMap = mapOf(
            ...
            HybridAquaticEntityTypes.AFRICAN_BUTTERFLY.get() to "African Butterfly Fish",
            ...
            HybridAquaticEntityTypes.TOADFISH.get() to "Toadfish",
            ...
            HybridAquaticEntityTypes.NUDIBRANCH.get() to "Nudibranch",
            ...
            HybridAquaticEntityTypes.FRIED_EGG_JELLYFISH.get() to "Fried Egg Jellyfish",
            HybridAquaticEntityTypes.CAULIFLOWER_JELLYFISH.get() to "Cauliflower Jellyfish",
            ...
            HybridAquaticEntityTypes.COMPASS_JELLYFISH.get() to "Compass Jellyfish",
