...
//#endregion
        ...
        getOrCreateTagBuilder(BlockTags.MINEABLE_WITH_AXE)
            ...
            .add(HybridAquaticBlocks.OAK_RAFT.get())
            .add(HybridAquaticBlocks.SPRUCE_RAFT.get())
            .add(HybridAquaticBlocks.BIRCH_RAFT.get())
            .add(HybridAquaticBlocks.DARK_OAK_RAFT.get())
            .add(HybridAquaticBlocks.JUNGLE_RAFT.get())
            .add(HybridAquaticBlocks.ACACIA_RAFT.get())
            .add(HybridAquaticBlocks.MANGROVE_RAFT.get())
            .add(HybridAquaticBlocks.CHERRY_RAFT.get())
            .add(HybridAquaticBlocks.DRIFTWOOD_RAFT.get())
