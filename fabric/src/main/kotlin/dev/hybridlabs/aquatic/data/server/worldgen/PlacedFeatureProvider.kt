...
class PlacedFeatureProvider(
    ...
    override fun configure(registries: HolderLookup.Provider, entries: Entries) {
        ...
        entries.add(reg.getOrThrow(HAPlacedFeatures.BLEACHED_REEF_VEGETATION))
        ...
        entries.add(reg.getOrThrow(HAPlacedFeatures.TIDE_POOL_MUSSEL_PATCH))
        ...
        entries.add(reg.getOrThrow(HAPlacedFeatures.WATER_HYACINTH))
        entries.add(reg.getOrThrow(HAPlacedFeatures.WATER_LETTUCE))
        entries.add(reg.getOrThrow(HAPlacedFeatures.WHITE_MOUND))
