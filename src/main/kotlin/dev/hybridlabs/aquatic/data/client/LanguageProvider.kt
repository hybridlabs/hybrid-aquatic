...
class LanguageProvider(output: FabricDataOutput) : FabricLanguageProvider(output) {
    override fun generateTranslations(builder: TranslationBuilder) {
        ...
        mapOf(
            ...
            HybridAquaticBlocks.GIANT_GREEN_ANEMONE to "Giant Green Anemone",
        ...
        mapOf(
            ...
            HybridAquaticItems.BLOWFISH to "Blowfish",
    ...
    private fun generateEntities(builder: TranslationBuilder) {
        ...
        val entityNameMap = mapOf(
            ...
            HybridAquaticEntityTypes.WRECKFISH to "Wreckfish",
            ...
            HybridAquaticEntityTypes.BLOWFISH to "Toadfish",
            ...
            HybridAquaticEntityTypes.SEADRAGON to "Seadragon",
            ...
            HybridAquaticEntityTypes.SEA_SLUG to "Sea Slug",
            ...
            HybridAquaticEntityTypes.CEPHEIDAE_JELLYFISH to "Cepheidae Jellyfish",
