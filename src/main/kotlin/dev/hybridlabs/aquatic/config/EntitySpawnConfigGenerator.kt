...
class EntitySpawnConfigGenerator {
    ...
    fun initialize() {
        ...
        addFish(HybridAquaticEntityTypes.DAMSELFISH, listOf(HybridAquaticBiomeTags.REEF, HybridAquaticBiomeTags.TROPICAL_OCEANS), 5, 3, 5)
        ...
        addFish(HybridAquaticEntityTypes.SHEEPSHEAD_WRASSE, listOf(HybridAquaticBiomeTags.TEMPERATE_OCEANS), 3, 1, 1)
        addFish(HybridAquaticEntityTypes.SEAHORSE, listOf(HybridAquaticBiomeTags.REEF), 1, 1, 2)
        addFish(HybridAquaticEntityTypes.SEADRAGON, listOf(HybridAquaticBiomeTags.TEMPERATE_OCEANS, HybridAquaticBiomeTags.DEEP_TROPICAL_OCEANS), 1, 1, 2)
        ...
        addShark(HybridAquaticEntityTypes.HOUND_SHARK, listOf(HybridAquaticBiomeTags.SHALLOW_TEMPERATE_OCEANS, HybridAquaticBiomeTags.SHALLOW_TROPICAL_OCEANS), 3, 1, 3)
        ...
        //#region Dolphins
        addDolphin(HybridAquaticEntityTypes.KILLER_WHALE, listOf(HybridAquaticBiomeTags.TEMPERATE_OCEANS, HybridAquaticBiomeTags.COLD_OCEANS, HybridAquaticBiomeTags.ARCTIC_OCEANS), 5, 1, 4)
        //#endregion
        ...
        //#region Critters
        addCritter(HybridAquaticEntityTypes.SEA_SLUG, listOf(HybridAquaticBiomeTags.COLD_OCEANS, HybridAquaticBiomeTags.TEMPERATE_OCEANS, HybridAquaticBiomeTags.TROPICAL_OCEANS, HybridAquaticBiomeTags.REEF), 3, 1, 2)
        ...
        addCritter(HybridAquaticEntityTypes.SEA_URCHIN, listOf(BiomeTags.IS_OCEAN, BiomeTags.IS_DEEP_OCEAN), 5, 1, 3)
        //#endregion
    }
