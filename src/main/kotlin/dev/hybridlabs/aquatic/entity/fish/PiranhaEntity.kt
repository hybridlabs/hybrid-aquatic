...
class PiranhaEntity(entityType: EntityType<out PiranhaEntity>, world: World) :
    ...
    override fun initGoals() {
        ...
        targetSelector.add(1, ActiveTargetGoal(this, LivingEntity::class.java, 10, true, true) { entity, type -> entity.hasStatusEffect(HybridAquaticStatusEffects.BLEEDING) && entity !is PiranhaEntity })
    }
