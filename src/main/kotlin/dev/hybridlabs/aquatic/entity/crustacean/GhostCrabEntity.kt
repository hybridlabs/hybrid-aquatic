...
class GhostCrabEntity(entityType: EntityType<out HybridAquaticCrustaceanEntity>, world: World) :
    ...
    VariantHolder<GhostCrabEntity.Type> {
    ...
    companion object {
        ...
        val TYPE: TrackedData<Int> = DataTracker.registerData(GhostCrabEntity::class.java, TrackedDataHandlerRegistry.INTEGER)
    }
    ...
    enum class Type(val id: Int, private val key: String) : StringIdentifiable {
        ...
        companion object {
            ...
            fun byName(name: String?): Type {
                return CODEC.byId(name, PURPLE) as Type
            }
