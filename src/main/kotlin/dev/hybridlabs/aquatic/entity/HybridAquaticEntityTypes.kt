...
object HybridAquaticEntityTypes {
    ...
    val ANGLERFISH = registerFish(
        "anglerfish",
        HybridAquaticSpawnGroup.FISH_UNDERGROUND.spawnGroup,
        ::AnglerfishEntity,
    ...
    val MOON_JELLYFISH = registerJelly(
        ...
        ::MoonJellyfishEntity,
        EntityDimensions.fixed(0.5f, 0.5f),
        MoonJellyfishEntity.createMobAttributes().build()
    )
    ...
    val FRIED_EGG_JELLY = registerJelly(
        ...
        EntityDimensions.fixed(0.5f, 0.5f),
        FriedEggJellyfishEntity.createMobAttributes().build()
    )
    ...
    val CAULIFLOWER_JELLY = registerJelly(
        ...
        EntityDimensions.fixed(0.5f, 0.5f),
        CauliflowerJellyfishEntity.createMobAttributes().build()
    )
    ...
    val NOMURA_JELLY = registerJelly(
        ...
        NomuraJellyfishEntity.createMobAttributes().build()
    )
    ...
    val BARREL_JELLY = registerJelly(
        ...
        BarrelJellyfishEntity.createMobAttributes().build()
    )
    ...
    val COMPASS_JELLY = registerJelly(
        ...
        EntityDimensions.fixed(1.0f, 1.5f),
        CompassJellyfishEntity.createMobAttributes().build()
    )
    ...
    val BLUE_JELLY = registerJelly(
        ...
        ::BlueJellyfishEntity,
        EntityDimensions.fixed(1.0f, 1.5f),
        BlueJellyfishEntity.createMobAttributes().build()
    )
    ...
    val MAUVE_STINGER = registerJelly(
        ...
        ::MauveStingerEntity,
        EntityDimensions.fixed(0.5f, 0.5f),
        MauveStingerEntity.createMobAttributes().build()
    )
    ...
    val LIONS_MANE_JELLYFISH = registerJelly(
        ...
        LionsManeJellyfishEntity.createMobAttributes().build()
    )
    ...
    val ATOLLA_JELLYFISH = registerJelly(
        ...
        EntityDimensions.fixed(2.5f, 3.0f),
        AtollaJellyfishEntity.createMobAttributes().build()
    )
    //endregion jellyfish
    //region sharks
    ...
    private inline fun <reified T : HybridAquaticSharkEntity> registerShark(
        ...
        return registerLiving(id, FabricEntityTypeBuilder.create(HybridAquaticSpawnGroup.SHARK.spawnGroup, entityFactory).dimensions(dimensions).build(), attributeContainer)
    }
    ...
    private inline fun <reified T : HybridAquaticCritterEntity> registerCritter(
        ...
        return registerLiving(id, FabricEntityTypeBuilder.create(HybridAquaticSpawnGroup.CRITTER.spawnGroup, entityFactory).dimensions(dimensions).build(), attributeContainer)
    }
    ...
    private inline fun <reified T : HybridAquaticFishEntity> registerFish(
        ...
        return registerFish(id, HybridAquaticSpawnGroup.FISH.spawnGroup, entityFactory, dimensions, attributeContainer)
    }
    ...
    private inline fun <reified T : HybridAquaticJellyfishEntity> registerJelly(
        ...
        return registerLiving(id, FabricEntityTypeBuilder.create(HybridAquaticSpawnGroup.JELLY.spawnGroup, entityFactory).dimensions(dimensions).build(), attributeContainer)
    }
