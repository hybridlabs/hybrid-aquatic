...
class TubeSpongeBlock(
    ...
    companion object {
        val CODEC: MapCodec<TubeSpongeBlock> = RecordCodecBuilder.mapCodec { instance ->
            instance.group(
                Codec.BOOL.fieldOf("emits_particles").forGetter(TubeSpongeBlock::emitsParticles),
                createSettingsCodec()
            ).apply(instance, ::TubeSpongeBlock)
        }
