...
object HybridAquaticItems {
    ...
    val DIVING_BOOTS: Item = register(
        "diving_boots",
        DivingArmorItem(HybridAquaticArmorMaterials.DIVING, ArmorItem.Type.BOOTS, Item.Settings().maxCount(1))
    )
    ...
    val TURTLE_CHESTPLATE: Item = register(
        "turtle_chestplate",
        TurtleArmorItem(HybridAquaticArmorMaterials.TURTLE, ArmorItem.Type.CHESTPLATE, Item.Settings().maxCount(1))
    )
    ...
    val FLOATING_SARGASSUM =
        registerPlaceableInWaterBlockItem("floating_sargassum", HybridAquaticBlocks.FLOATING_SARGASSUM)
    ...
    val AFRICAN_BUTTERFLY_SPAWN_EGG = registerSpawnEgg(
        "african_butterfly_spawn_egg",
    ...
    val SHEEPSHEAD_WRASSE_SPAWN_EGG =
        registerSpawnEgg("sheepshead_wrasse_spawn_egg", HybridAquaticEntityTypes.SHEEPSHEAD_WRASSE, 0x2c2628, 0xdc5f5d)
    ...
    val WRECKFISH_SPAWN_EGG =
        registerSpawnEgg("wreckfish_spawn_egg", HybridAquaticEntityTypes.WRECKFISH, 0x711b2f, 0xeb5948)
    ...
    val CEPHEIDAE_JELLYFISH_SPAWN_EGG = registerSpawnEgg(
    ...
    val KILLER_WHALE_SPAWN_EGG =
        registerSpawnEgg("killer_whale_spawn_egg", HybridAquaticEntityTypes.KILLER_WHALE, 0x21222e, 0xe6e6ec)
