 ...
 * @see BlahajPlushieBlock.Variant.GREAT_WHITE_SHARK
 */
class GreatWhiteSharkBlahajPlushieModel(override val root: ModelPart) : BlahajPlushieModel() {
        ...
        fun createModelData(): TexturedModelData {
            ...
            rootPart.addChild(
                ...
                ModelPartBuilder.create()
                    ...
                    .uv(11, 9).cuboid(-2.0F, -1.0F, -4.5F, 4.0F, 1.0F, 2.0F)
