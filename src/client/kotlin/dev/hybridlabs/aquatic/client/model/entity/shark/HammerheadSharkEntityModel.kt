...
class HammerheadSharkEntityModel : HybridAquaticSharkEntityModel<HammerheadSharkEntity>("hammerhead_shark") {
    ...
    private val commonTextures = listOf(
        Identifier.of("hybrid-aquatic", "textures/entity/shark/hammerhead_shark/hammerhead_shark.png"),
        Identifier.of("hybrid-aquatic", "textures/entity/shark/hammerhead_shark/hammerhead_shark_brown.png"),
        Identifier.of("hybrid-aquatic", "textures/entity/shark/hammerhead_shark/hammerhead_shark_olive.png")
    )
