...
class MahiEntityModel : HybridAquaticFishEntityModel<MahiEntity>("mahi") {
    ...
    private val MAHI_TEXTURE = Identifier.of("hybrid-aquatic", "textures/entity/fish/mahi/mahi_mahi.png")
    private val POMPANO_TEXTURE = Identifier.of("hybrid-aquatic", "textures/entity/fish/mahi/mahi_pompano.png")

    private val MAHI_MODEL = Identifier.of("hybrid-aquatic", "geo/fish/mahi/mahi_mahi.geo.json")
    private val POMPANO_MODEL = Identifier.of("hybrid-aquatic", "geo/fish/mahi/mahi_pompano.geo.json")
