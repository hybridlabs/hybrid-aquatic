...
class AnemoneBlockEntityModel : GeoModel<AnemoneBlockEntity>() {
    ...
    companion object {
        val ANIMATION_LOCATION: Identifier = Identifier.of(HybridAquatic.MOD_ID, "animations/anemone.animation.json")
        val MODEL_LOCATION: Identifier = Identifier.of(HybridAquatic.MOD_ID, "geo/anemone.geo.json")
        val TEXTURE_LOCATION: Identifier = Identifier.of(HybridAquatic.MOD_ID, "textures/block/anemone.png")
    }
}
