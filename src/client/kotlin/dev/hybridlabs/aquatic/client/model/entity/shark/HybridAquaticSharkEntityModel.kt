...
abstract class HybridAquaticSharkEntityModel<T : HybridAquaticSharkEntity> (
    ...
    override fun getModelResource(animatable: T): Identifier {
        return Identifier.of(HybridAquatic.MOD_ID, "geo/shark/$id/$id.geo.json")
    }

    override fun getTextureResource(animatable: T): Identifier {
        return Identifier.of(HybridAquatic.MOD_ID, "textures/entity/shark/$id/$id.png")
    }
    ...
    fun getLayerTextureResource(layer: String): Identifier {
        return Identifier.of(HybridAquatic.MOD_ID, "textures/entity/shark/$id/layers/${id}_$layer.png")
    }
