...
class GiantClamBlockEntityModel: GeoModel<GiantClamBlockEntity>() {
    ...
    companion object {
        val ANIMATION_LOCATION: Identifier = Identifier.of(HybridAquatic.MOD_ID, "animations/giant_clam.animation.json")
        val MODEL_LOCATION: Identifier = Identifier.of(HybridAquatic.MOD_ID, "geo/giant_clam.geo.json")
        val TEXTURE_LOCATION: Identifier = Identifier.of(HybridAquatic.MOD_ID, "textures/block/giant_clam.png")
    }
}
