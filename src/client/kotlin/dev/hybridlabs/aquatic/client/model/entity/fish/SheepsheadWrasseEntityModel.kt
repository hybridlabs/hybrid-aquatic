...
class SheepsheadWrasseEntityModel : HybridAquaticFishEntityModel<SheepsheadWrasseEntity>("sheepshead_wrasse") {
    ...
    private val CALIFORNIA_SHEEPSHEAD_TEXTURE = Identifier.of("hybrid-aquatic", "textures/entity/fish/wrasse/california_sheepshead.png")

    private val CALIFORNIA_SHEEPSHEAD_MODEL = Identifier.of("hybrid-aquatic", "geo/fish/wrasse/california_sheepshead.geo.json")
