...
class StrawberryAnemoneBlockEntityModel : GeoModel<StrawberryAnemoneBlockEntity>() {
    ...
    companion object {
        ...
        val MODEL_LOCATION = Identifier.of(HybridAquatic.MOD_ID, "geo/strawberry_anemone.geo.json")
        val TEXTURE_LOCATION = Identifier.of(HybridAquatic.MOD_ID, "textures/block/strawberry_anemone.png")
    }
}
