...
class WreckfishEntityModel : HybridAquaticFishEntityModel<WreckfishEntity>("wreckfish") {
    ...
    private val GIANT_SEA_BASS_TEXTURE = Identifier("hybrid-aquatic", "textures/entity/fish/wreckfish/giant_sea_bass.png")

    private val GIANT_SEA_BASS_MODEL = Identifier("hybrid-aquatic", "geo/fish/wreckfish/giant_sea_bass.geo.json")
