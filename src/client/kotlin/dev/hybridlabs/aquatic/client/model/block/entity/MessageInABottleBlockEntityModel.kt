...
class MessageInABottleBlockEntityModel : GeoModel<MessageInABottleBlockEntity>() {
    ...
    companion object {
        val VARIANT_MODELS = mapOf(
            Variant.BOTTLE to Identifier.of(HybridAquatic.MOD_ID, "geo/entity/block/message_in_a_bottle/message_in_a_bottle.geo.json"),
            Variant.JAR to Identifier.of(HybridAquatic.MOD_ID, "geo/entity/block/message_in_a_bottle/message_in_a_bottle_jar.geo.json"),
            Variant.LONGNECK to Identifier.of(HybridAquatic.MOD_ID, "geo/entity/block/message_in_a_bottle/message_in_a_bottle_longneck.geo.json"),
        )

        val VARIANT_TEXTURES = mapOf(
            Variant.BOTTLE to Identifier.of(HybridAquatic.MOD_ID, "textures/entity/block/message_in_a_bottle/message_in_a_bottle.png"),
            Variant.JAR to Identifier.of(HybridAquatic.MOD_ID, "textures/entity/block/message_in_a_bottle/message_in_a_bottle_jar.png"),
