...
import dev.hybridlabs.aquatic.client.model.block.entity.GiantClamBlockEntityModel
...
class GiantClamBlockEntityRenderer(context: Context) : GeoBlockRenderer<GiantClamBlockEntity>(GiantClamBlockEntityModel()) {
    private val random = Random.create()

    override fun preRender(
        matrices: MatrixStack,
        blockEntity: GiantClamBlockEntity,
        model: BakedGeoModel,
