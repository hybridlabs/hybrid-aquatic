...
import dev.hybridlabs.aquatic.client.render.armor.StripedEelArmorRenderer
...
class StripedEelScarfItem(type: Type, settings: Properties) :
        ...
        consumer.accept(object : GeoRenderProvider {
            ...
            override fun <T : LivingEntity?> getGeoArmorRenderer(
                ...
                if (this.renderer == null)
                    this.renderer = StripedEelArmorRenderer()
