...
class GiantGreenAnemoneBlockEntity(pos: BlockPos, state: BlockState) : BlockEntity(HybridAquaticBlockEntityTypes.GIANT_GREEN_ANEMONE, pos, state), GeoAnimatable {
