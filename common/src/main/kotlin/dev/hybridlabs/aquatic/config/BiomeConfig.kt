    ...
    companion object {
        val CODEC: Codec<BiomeConfig> = RecordCodecBuilder.create { instance ->
            instance.group(
                ...
                Codec.BOOL.fieldOf("generate_seasonal_river").forGetter(BiomeConfig::generateSeasonalRiver),
                Codec.BOOL.fieldOf("generate_placer_river").forGetter(BiomeConfig::generatePlacerRiver),
                Codec.BOOL.fieldOf("generate_cold_river").forGetter(BiomeConfig::generateColdRiver),
