...
class EntitySpawnConfigGenerator {
    ...
    fun initialize() {
        ...
        addFish(
            ...
            listOf(HybridAquaticBiomeTags.JUNGLE, HybridAquaticBiomeTags.MARSHES, HybridAquaticBiomeTags.MANGROVES),
            2,
            1,
            1
        )
        ...
        addFish(
            ...
            listOf(HybridAquaticBiomeTags.JUNGLE, HybridAquaticBiomeTags.TROPICAL_RIVERS),
            3,
            2,
            5
        )
        ...
        addFish(
            ...
            listOf(HybridAquaticBiomeTags.SWAMP, HybridAquaticBiomeTags.MANGROVES, HybridAquaticBiomeTags.MARSHES),
            1,
            1,
            1
        )
        ...
        addFish(
            ...
            listOf(HybridAquaticBiomeTags.CHERRY, HybridAquaticBiomeTags.RIVERS),
            5,
            1,
            2
        )
        addFish(
            ...
            listOf(HybridAquaticBiomeTags.DEEP_TEMPERATE_OCEANS, HybridAquaticBiomeTags.DEEP_TROPICAL_OCEANS),
            1,
            1,
            1
        )
        ...
        addFish(
            ...
            listOf(HybridAquaticBiomeTags.REEF, HybridAquaticBiomeTags.TROPICAL_OCEANS),
            5,
            3,
            5
        )
        addFish(
            ...
            listOf(HybridAquaticBiomeTags.COLD_OCEANS, HybridAquaticBiomeTags.TEMPERATE_OCEANS),
            5,
            3,
            5
        )
        ...
        addFish(
            ...
            listOf(HybridAquaticBiomeTags.SHALLOW_TEMPERATE_OCEANS, HybridAquaticBiomeTags.TROPICAL_OCEANS),
            3,
            1,
            3
        )
        ...
        addFish(HybridAquaticEntityTypes.TOADFISH.get(), listOf(HybridAquaticBiomeTags.REEF), 1, 1, 1)
        ...
        addUndergroundFish(
            ...
            listOf(HybridAquaticBiomeTags.TROPICAL_OCEANS, HybridAquaticBiomeTags.TEMPERATE_OCEANS),
            1,
            1,
            1
        )
        ...
        addUndergroundFish(
            ...
            listOf(HybridAquaticBiomeTags.ARCTIC_OCEANS, HybridAquaticBiomeTags.COLD_OCEANS),
            1,
            1,
            1
        )
        ...
        addCephalopod(
            ...
            listOf(HybridAquaticBiomeTags.COLD_OCEANS, HybridAquaticBiomeTags.ARCTIC_OCEANS),
            5,
            1,
            3
        )
        ...
        addUndergroundCephalopod(
            HybridAquaticEntityTypes.VAMPIRE_SQUID.get(),
            listOf(HybridAquaticBiomeTags.TROPICAL_OCEANS),
            2,
            1,
            1
        )
        ...
        addJelly(
            ...
            listOf(HybridAquaticBiomeTags.TEMPERATE_OCEANS),
            5,
            1,
            3
        )
        ...
        addJelly(HybridAquaticEntityTypes.SEA_NETTLE.get(), listOf(HybridAquaticBiomeTags.TROPICAL_OCEANS), 5, 3, 5)
        addJelly(
        ...
        addShark(
            ...
            listOf(HybridAquaticBiomeTags.TEMPERATE_OCEANS, HybridAquaticBiomeTags.SHALLOW_TROPICAL_OCEANS),
            2,
            1,
            2
        )
        ...
        addShark(
            ...
            listOf(HybridAquaticBiomeTags.DEEP_TROPICAL_OCEANS),
            2,
            1,
            1
        )
        ...
        addCrustacean(
            ...
            listOf(HybridAquaticBiomeTags.SANDY_BEACHES),
            5,
            2,
            3
        )
        ...
        addCrustacean(
            ...
            listOf(HybridAquaticBiomeTags.SHALLOW_TROPICAL_OCEANS),
            3,
            1,
            1
        )
        addCrustacean(
            ...
            listOf(HybridAquaticBiomeTags.ROCKY_BEACHES),
            3,
            1,
            3
        )
        ...
        addCrustacean(
            ...
            listOf(HybridAquaticBiomeTags.REEF, HybridAquaticBiomeTags.SHALLOW_TROPICAL_OCEANS),
            3,
            1,
            2
        )
        ...
        addCrustacean(
            ...
            listOf(HybridAquaticBiomeTags.SANDY_BEACHES, HybridAquaticBiomeTags.SHALLOW_TROPICAL_OCEANS),
            3,
            1,
            2
        )
        ...
        addUndergroundCrustacean(
            HybridAquaticEntityTypes.YETI_CRAB.get(),
            listOf(HybridAquaticBiomeTags.DEEP_COLD_OCEANS, HybridAquaticBiomeTags.DEEP_ARCTIC_OCEANS),
            3,
            2,
            2
        )
        ...
        addUndergroundCrustacean(
            ...
            listOf(HybridAquaticBiomeTags.TEMPERATE_OCEANS, HybridAquaticBiomeTags.COLD_OCEANS),
            3,
            1,
            2
        )
        ...
        addCritter(
            ...
            listOf(BiomeTags.IS_OCEAN, BiomeTags.IS_DEEP_OCEAN),
            3,
            1,
            3
        )
    ...
    private fun addUndergroundCephalopod(
        ...
        add(
            entityType, spawnTags, HybridAquaticSpawnGroup.CEPHALOPOD.spawnGroup, weight, minGroup, maxGroup
        )
    }
