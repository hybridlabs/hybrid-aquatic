...
object HybridAquaticEntityRenderers {
    //region fish
    val AFRICAN_BUTTERFLY = ClientServices.PLATFORM.registerEntityRenderer(
    ...
    val JOHN_DORY = ClientServices.PLATFORM.registerEntityRenderer(
        HybridAquaticEntityTypes.JOHN_DORY,
        ::JohnDoryEntityRenderer
    )
    val SNAILFISH = ClientServices.PLATFORM.registerEntityRenderer(
        HybridAquaticEntityTypes.SNAILFISH,
        ::SnailfishEntityRenderer
    )
    val PEARLFISH = ClientServices.PLATFORM.registerEntityRenderer(
        HybridAquaticEntityTypes.PEARLFISH,
        ::PearlfishEntityRenderer
    )
    val PIRANHA =
        ClientServices.PLATFORM.registerEntityRenderer(HybridAquaticEntityTypes.PIRANHA, ::PiranhaEntityRenderer)
    val BARRELEYE = ClientServices.PLATFORM.registerEntityRenderer(
        HybridAquaticEntityTypes.BARRELEYE,
        ::BarreleyeEntityRenderer
    )
    val CLOWNFISH = ClientServices.PLATFORM.registerEntityRenderer(
        HybridAquaticEntityTypes.CLOWNFISH,
        ::ClownfishEntityRenderer
    )
    val TUNA = ClientServices.PLATFORM.registerEntityRenderer(HybridAquaticEntityTypes.TUNA, ::TunaEntityRenderer)
    val GOLDEN_DORADO =
        ClientServices.PLATFORM.registerEntityRenderer(
    ...
    val LIONFISH = ClientServices.PLATFORM.registerEntityRenderer(
        HybridAquaticEntityTypes.LIONFISH,
        ::LionfishEntityRenderer
    )
    val OARFISH =
        ClientServices.PLATFORM.registerEntityRenderer(HybridAquaticEntityTypes.OARFISH, ::OarfishEntityRenderer)
    val SEA_ANGEL = ClientServices.PLATFORM.registerEntityRenderer(
        HybridAquaticEntityTypes.SEA_ANGEL,
        ::SeaAngelEntityRenderer
    )
    val OPAH = ClientServices.PLATFORM.registerEntityRenderer(HybridAquaticEntityTypes.OPAH, ::OpahEntityRenderer)
    val SUNFISH =
        ClientServices.PLATFORM.registerEntityRenderer(HybridAquaticEntityTypes.SUNFISH, ::SunfishEntityRenderer)
    val MAHI = ClientServices.PLATFORM.registerEntityRenderer(HybridAquaticEntityTypes.MAHI, ::MahiEntityRenderer)
    val MORAY_EEL = ClientServices.PLATFORM.registerEntityRenderer(
        HybridAquaticEntityTypes.MORAY_EEL,
        ::MorayEelEntityRenderer
    )
    val ROCKFISH = ClientServices.PLATFORM.registerEntityRenderer(
        HybridAquaticEntityTypes.ROCKFISH,
        ::RockfishEntityRenderer
    )
    val SEA_BASS =
        ClientServices.PLATFORM.registerEntityRenderer(HybridAquaticEntityTypes.SEA_BASS, ::SeaBassEntityRenderer)
    val TIGER_BARB =
        ClientServices.PLATFORM.registerEntityRenderer(
    ...
    val MACKEREL = ClientServices.PLATFORM.registerEntityRenderer(
        HybridAquaticEntityTypes.MACKEREL,
        ::MackerelEntityRenderer
    )
    val RATFISH =
        ClientServices.PLATFORM.registerEntityRenderer(HybridAquaticEntityTypes.RATFISH, ::RatfishEntityRenderer)
    val TRIGGERFISH =
        ClientServices.PLATFORM.registerEntityRenderer(
    ...
    val OSCAR =
        ClientServices.PLATFORM.registerEntityRenderer(HybridAquaticEntityTypes.OSCAR, ::OscarEntityRenderer)
    val DANIO =
        ClientServices.PLATFORM.registerEntityRenderer(HybridAquaticEntityTypes.DANIO, ::DanioEntityRenderer)
    val TOADFISH = ClientServices.PLATFORM.registerEntityRenderer(
        HybridAquaticEntityTypes.BLOWFISH,
        ::BlowfishEntityRenderer
    )
    val TETRA =
        ClientServices.PLATFORM.registerEntityRenderer(HybridAquaticEntityTypes.TETRA, ::TetraEntityRenderer)
    val STONEFISH = ClientServices.PLATFORM.registerEntityRenderer(
        HybridAquaticEntityTypes.STONEFISH,
        ::StonefishEntityRenderer
    )
    val BETTA =
        ClientServices.PLATFORM.registerEntityRenderer(HybridAquaticEntityTypes.BETTA, ::BettaEntityRenderer)
    val GOLDFISH = ClientServices.PLATFORM.registerEntityRenderer(
        HybridAquaticEntityTypes.GOLDFISH,
        ::GoldfishEntityRenderer
    )
    val SEAHORSE = ClientServices.PLATFORM.registerEntityRenderer(
    ...
    val GOURAMI =
        ClientServices.PLATFORM.registerEntityRenderer(HybridAquaticEntityTypes.GOURAMI, ::GouramiEntityRenderer)
    val BOXFISH =
        ClientServices.PLATFORM.registerEntityRenderer(HybridAquaticEntityTypes.BOXFISH, ::BoxfishEntityRenderer)
    val DISCUS =
        ClientServices.PLATFORM.registerEntityRenderer(HybridAquaticEntityTypes.DISCUS, ::DiscusEntityRenderer)
    val SURGEONFISH =
        ClientServices.PLATFORM.registerEntityRenderer(
    ...
    val CARP = ClientServices.PLATFORM.registerEntityRenderer(HybridAquaticEntityTypes.CARP, ::CarpEntityRenderer)

    //endregion

    //region rays
    val STINGRAY = ClientServices.PLATFORM.registerEntityRenderer(
        HybridAquaticEntityTypes.STINGRAY,
        ::StingrayEntityRenderer
    )
    val MANTA_RAY = ClientServices.PLATFORM.registerEntityRenderer(
    ...
    val UMBRELLA_OCTOPUS = ClientServices.PLATFORM.registerEntityRenderer(
    ...
    val NAUTILUS = ClientServices.PLATFORM.registerEntityRenderer(
    ...
    val GLOWING_SUCKER_OCTOPUS = ClientServices.PLATFORM.registerEntityRenderer(
    ...
    val LIONS_MANE_JELLYFISH = ClientServices.PLATFORM.registerEntityRenderer(
    ...
    val YETI_CRAB = ClientServices.PLATFORM.registerEntityRenderer(
    ...
    val SHRIMP =
        ClientServices.PLATFORM.registerEntityRenderer(HybridAquaticEntityTypes.SHRIMP, ::ShrimpEntityRenderer)
    val CRAYFISH = ClientServices.PLATFORM.registerEntityRenderer(
        HybridAquaticEntityTypes.CRAYFISH,
        ::CrayfishEntityRenderer
    )
    val LOBSTER =
        ClientServices.PLATFORM.registerEntityRenderer(HybridAquaticEntityTypes.LOBSTER, ::LobsterEntityRenderer)
    val COCONUT_CRAB =
        ClientServices.PLATFORM.registerEntityRenderer(
    ...
    //region critters
    val STARFISH = ClientServices.PLATFORM.registerEntityRenderer(
        HybridAquaticEntityTypes.STARFISH,
        ::StarfishEntityRenderer
    )
    val NUDIBRANCH =
        ClientServices.PLATFORM.registerEntityRenderer(HybridAquaticEntityTypes.SEA_SLUG, ::SeaSlugEntityRenderer)
    val SEA_CUCUMBER =
        ClientServices.PLATFORM.registerEntityRenderer(
    ...
    //region minibosses
    val KARKINOS = ClientServices.PLATFORM.registerEntityRenderer(
