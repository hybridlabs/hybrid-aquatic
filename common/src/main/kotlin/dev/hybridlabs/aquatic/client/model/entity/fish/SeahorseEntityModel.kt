...
class SeahorseEntityModel : HybridAquaticFishEntityModel<SeahorseEntity>("seahorse") {
    ...
    private val COMMON_TEXTURE = ResourceLocation.fromNamespaceAndPath("hybrid-aquatic", "textures/entity/fish/seahorse/seahorse_common.png")
    private val PYGMY_TEXTURE = ResourceLocation.fromNamespaceAndPath("hybrid-aquatic", "textures/entity/fish/seahorse/seahorse_pygmy.png")
    private val THORNY_TEXTURE = ResourceLocation.fromNamespaceAndPath("hybrid-aquatic", "textures/entity/fish/seahorse/seahorse_thorny.png")
    private val BIG_BELLY_TEXTURE = ResourceLocation.fromNamespaceAndPath("hybrid-aquatic", "textures/entity/fish/seahorse/seahorse_big_belly.png")
