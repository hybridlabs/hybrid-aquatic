...
class FlashlightFishEntityModel : HAFishEntityModel<FlashlightFishEntity>("flashlight_fish") {
    ...
    companion object {
        private val ONE_FISH_MODEL =
            ResourceLocation("hybrid-aquatic", "geo/fish/flashlight_fish/flashlight_fish_.geo.json")
        ...
        private val ONE_FISH_ANIMATION =
            ResourceLocation("hybrid-aquatic", "animations/entity/fish/flashlight_fish/flashlight_fish_.animation.json")
