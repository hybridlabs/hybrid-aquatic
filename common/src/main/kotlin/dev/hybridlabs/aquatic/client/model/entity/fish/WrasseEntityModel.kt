...
class WrasseEntityModel : HAFishEntityModel<WrasseEntity>("wrasse") {
    ...
    companion object {
        private val CALIFORNIA_SHEEPSHEAD_TEXTURE =
            ResourceLocation("hybrid-aquatic", "textures/entity/fish/wrasse/california_sheepshead.png")

        private val CALIFORNIA_SHEEPSHEAD_MODEL =
            ResourceLocation("hybrid-aquatic", "geo/fish/wrasse/california_sheepshead.geo.json")
    }
