...
class SeaCucumberEntityModel : HACritterEntityModel<SeaCucumberEntity>("sea_cucumber") {
    ...
    companion object {
        private val commonTextures = listOf(
            ResourceLocation("hybrid_aquatic", "textures/entity/critter/sea_cucumber/sea_cucumber_black_teatfish.png"),
            ResourceLocation("hybrid_aquatic", "textures/entity/critter/sea_cucumber/sea_cucumber_white_teatfish.png"),
            ResourceLocation("hybrid_aquatic", "textures/entity/critter/sea_cucumber/sea_cucumber_greenfish.png"),
            ResourceLocation("hybrid_aquatic", "textures/entity/critter/sea_cucumber/sea_cucumber_prickly_redfish.png"),
            ResourceLocation("hybrid_aquatic", "textures/entity/critter/sea_cucumber/sea_cucumber_curryfish.png"),
            ResourceLocation("hybrid_aquatic", "textures/entity/critter/sea_cucumber/sea_cucumber_sandfish.png")
        )

        private val SEA_PIG_TEXTURE =
            ResourceLocation("hybrid_aquatic", "textures/entity/critter/sea_cucumber/sea_pig.png")

        private val SEA_PIG_MODEL =
            ResourceLocation("hybrid_aquatic", "geo/critter/sea_cucumber/sea_pig.geo.json")
        private val SEA_CUCUMBER_MODEL =
            ResourceLocation("hybrid_aquatic", "geo/critter/sea_cucumber/sea_cucumber.geo.json")

        private val SEA_PIG_ANIMATION =
            ResourceLocation("hybrid_aquatic", "animations/entity/critter/sea_cucumber/sea_pig.animation.json")
        private val SEA_CUCUMBER_ANIMATION =
            ResourceLocation("hybrid_aquatic", "animations/entity/critter/sea_cucumber/sea_cucumber.animation.json")
    }
