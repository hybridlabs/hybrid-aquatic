...
class SeaCucumberEntityModel : HACritterEntityModel<SeaCucumberEntity>("sea_cucumber") {
    ...
    companion object {
        ...
        private val SEA_PIG_TEXTURE =
            ResourceLocation("hybrid-aquatic", "textures/entity/critter/sea_cucumber/sea_pig.png")

        private val SEA_PIG_MODEL =
            ResourceLocation("hybrid-aquatic", "geo/critter/sea_cucumber/sea_pig.geo.json")
        private val SEA_CUCUMBER_MODEL =
            ResourceLocation("hybrid-aquatic", "geo/critter/sea_cucumber/sea_cucumber.geo.json")

        private val SEA_PIG_ANIMATION =
            ResourceLocation("hybrid-aquatic", "animations/entity/critter/sea_cucumber/sea_pig.animation.json")
        private val SEA_CUCUMBER_ANIMATION =
            ResourceLocation("hybrid-aquatic", "animations/entity/critter/sea_cucumber/sea_cucumber.animation.json")
    }
