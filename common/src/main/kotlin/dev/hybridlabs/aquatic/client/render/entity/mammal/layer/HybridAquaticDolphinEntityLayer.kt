...
import dev.hybridlabs.aquatic.client.model.entity.mammal.HybridAquaticDolphinEntityModel
import dev.hybridlabs.aquatic.client.render.entity.mammal.HybridAquaticDolphinEntityRenderer
...
class HybridAquaticDolphinEntityLayer<T: HybridAquaticDolphinEntity>(
    renderer: HybridAquaticDolphinEntityRenderer<T>
) : GeoRenderLayer<T>(renderer) {

    private fun getLayerTextureResource(animatable: T, layer: String): ResourceLocation {
        return (geoModel as HybridAquaticDolphinEntityModel<T>).getLayerTextureResource(animatable, layer.lowercase())
    }
