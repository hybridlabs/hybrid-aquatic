...
class SeadragonEntityModel : HybridAquaticFishEntityModel<SeadragonEntity>("seadragon") {
    ...
    private val LEAFY_TEXTURE = ResourceLocation.fromNamespaceAndPath("hybrid-aquatic", "textures/entity/fish/seadragon/leafy_seadragon.png")
    private val WEEDY_TEXTURE = ResourceLocation.fromNamespaceAndPath("hybrid-aquatic", "textures/entity/fish/seadragon/weedy_seadragon.png")
    private val RUBY_TEXTURE = ResourceLocation.fromNamespaceAndPath("hybrid-aquatic", "textures/entity/fish/seadragon/ruby_seadragon.png")

    private val LEAFY_MODEL = ResourceLocation.fromNamespaceAndPath("hybrid-aquatic", "geo/fish/seadragon/leafy_seadragon.geo.json")
    private val WEEDY_MODEL = ResourceLocation.fromNamespaceAndPath("hybrid-aquatic", "geo/fish/seadragon/weedy_seadragon.geo.json")
    private val RUBY_MODEL = ResourceLocation.fromNamespaceAndPath("hybrid-aquatic", "geo/fish/seadragon/ruby_seadragon.geo.json")

    private val LEAFY_ANIMATION = ResourceLocation.fromNamespaceAndPath("hybrid-aquatic", "animations/seadragon_leafy.animation.json")
    private val WEEDY_ANIMATION = ResourceLocation.fromNamespaceAndPath("hybrid-aquatic", "animations/seadragon_weedy.animation.json")
    private val RUBY_ANIMATION = ResourceLocation.fromNamespaceAndPath("hybrid-aquatic", "animations/seadragon_ruby.animation.json")
