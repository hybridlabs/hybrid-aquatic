...
import net.minecraft.advancements.critereon.LightPredicate.Builder.light
...
abstract class PlushieModel : SkullModelBase() {
    ...
    override fun renderToBuffer(matrices: PoseStack, vertices: VertexConsumer, overlay: Int, p3: Int, p4: Int) {
        root.render(matrices, vertices, overlay, p3, p4)
    }
}
