...
class OctopusEntityModel : HybridAquaticOctopusEntityModel<OctopusEntity>("octopus") {
    ...
    private val COCONUT_OCTOPUS_TEXTURE = ResourceLocation("hybrid-aquatic", "textures/entity/cephalopod/octopus/coconut_octopus.png")

    private val OCTOPUS_MODEL = ResourceLocation("hybrid-aquatic", "geo/cephalopod/octopus/octopus.geo.json")
