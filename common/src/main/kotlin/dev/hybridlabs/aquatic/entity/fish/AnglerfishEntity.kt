...
class AnglerfishEntity(entityType: EntityType<out AnglerfishEntity>, world: Level) :
    ...
    override fun registerGoals() {
        ...
        targetSelector.addGoal(2, NearestAttackableTargetGoal(this, LivingEntity::class.java, 10, true, true) {
            it.hasEffect(HybridAquaticMobEffects.BLEEDING.get()) && it !is AnglerfishEntity
        })
    }
