...
abstract class HAMinionEntity(type: EntityType<out Monster>, world: Level) :
    ...
    companion object {
        val ATTEMPT_ATTACK: EntityDataAccessor<Boolean> =
            SynchedEntityData.defineId(HAMinionEntity::class.java, EntityDataSerializers.BOOLEAN)
