...
object SpawnRestrictionRegistry {
    ...
    private fun <T : BaseWaterAnimal> registerTerrestrialCrustacean(entityType: EntityType<T>) {
    ...
    private fun <T : BaseWaterAnimal> registerDeepCrustacean(entityType: EntityType<T>) {
