...
open class HASchoolingFishEntity(type: EntityType<out HAFishEntity>, world: Level) :
    HAFishEntity(type, world) {
    private var leader: HASchoolingFishEntity? = null
    ...
    fun joinGroupOf(groupLeader: HASchoolingFishEntity): HASchoolingFishEntity {
    ...
    fun pullInOtherFish(fish: Stream<out HASchoolingFishEntity?>) {
