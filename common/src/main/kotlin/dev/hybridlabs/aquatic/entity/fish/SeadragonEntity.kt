...
class SeadragonEntity(type: EntityType<out SeadragonEntity>, world: Level) :
    HybridAquaticFishEntity(type, world), VariantHolder<SeadragonEntity.Companion.Type> {
    ...
    companion object {
        ...
        fun canSpawn(
            type: EntityType<out SeadragonEntity>,
            world: ServerLevelAccessor,
            reason: MobSpawnType,
            pos: BlockPos,
            random: RandomSource,
        ...
        val TYPE: EntityDataAccessor<Int> =
            SynchedEntityData.defineId(SeadragonEntity::class.java, EntityDataSerializers.INT)
        ...
        enum class Type(val id: Int, private val key: String) : StringRepresentable {
            ...
            companion object {
                ...
                fun byName(name: String?): Type {
                    return CODEC.byName(name, LEAFY) as Type
                }
